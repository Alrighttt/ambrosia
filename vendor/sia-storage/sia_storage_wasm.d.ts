...
export interface InitOutput {
    ...
    readonly sdk_objectEvents: (a: number, b: number, c: number) => any;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h461ed1cf4779c6f2: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h461ed1cf4779c6f2_3: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h29f5bd75867abdc1: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h3bdeb7de158ed318: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hed868b385381c6ed: (a: number, b: number) => void;
