...
export interface InitOutput {
    ...
    readonly packedupload_slabSize: (a: number) => number;
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h6e16a16a730f244e: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h310b3e79f86d2c14: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h310b3e79f86d2c14_3: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h310b3e79f86d2c14_4: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h6bd91625313626ea: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h3ed55e440439b2de: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hb6419d1b46f84434: (a: number, b: number) => void;
